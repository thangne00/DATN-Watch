...
/* FRONTEND VOUCHER/PROMOTION ROUTES */
Route::prefix('voucher')->group(function () {
    Route::post('apply', [PromotionController::class, 'apply'])->name('voucher.apply');
    Route::post('remove', [PromotionController::class, 'remove'])->name('voucher.remove');
    Route::get('available', [PromotionController::class, 'getAvailable'])->name('voucher.available');
});

Route::get('cart/get-applied-discount', [PromotionController::class, 'getAppliedDiscount'])->name('cart.discount');

/* DEBUG ROUTES */
Route::get('debug-voucher', [PromotionController::class, 'debugSession'])->name('debug.voucher');
Route::get('clear-voucher', [PromotionController::class, 'clearVoucher'])->name('clear.voucher');
...
Route::group(['middleware' => ['admin', 'locale', 'backend_default_locale']], function () {
    ...
    Route::group(['prefix' => 'promotion'], function () {
        ...
        Route::get('{languageId}/{promotionId}/translate', [PromotionController::class, 'translate'])->where(['languageId' => '[0-9]+', 'promotionId' => '[0-9]+'])->name('promotion.translate');
    ...
    Route::group(['prefix' => 'order'], function () {
        ...
        Route::get('canceled', [OrderController::class, 'canceledOrders'])->name('admin.orders.canceled');
        Route::post('{id}/confirm-cancel', [OrderController::class, 'confirmCancel'])->name('admin.order.confirm-cancel');
    });
